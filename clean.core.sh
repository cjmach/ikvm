...
CLEANFLAGS="--nologo -c ${CONFIGURATION} -f ${TARGETFRAMEWORK}"
...
# dotnet clean ${CLEANFLAGS} tools/implib/implib.csproj
# dotnet clean ${CLEANFLAGS} ikvm/ikvm.csproj
# dotnet clean ${CLEANFLAGS} jvm/jvm.csproj
